...
from assistant_tools.tts import _load_kittentts_model  # pyright: ignore[reportPrivateUsage]
...
def test_load_model_uses_upstream_signature_without_backend() -> None:
    instance = _load_kittentts_model(_FakeKittenTTS, "KittenML/kitten-tts-micro-0.8")
